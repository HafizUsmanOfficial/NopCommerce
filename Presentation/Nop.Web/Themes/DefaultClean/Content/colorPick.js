  ...
  let palette = ["#4ab2f1", "#0000FF", "#C0C0C0", "#800000", "#008000", "#800080", "#008080", "#FFD700", "#964B00", "#000080", "#808000", "#FFFF00", "#00FFFF", "#FF00FF", "#000000"];
    ...
    $.fn.colorPick.defaults = {
        ...
        'onColorSelected': function() {
          this.element.css({ 'backgroundColor': this.color, 'color': this.color, 'opacity': '100%'});
        }
    };
    ...
    $.colorPick.prototype = {
        ...
        init : function(){
            ...
            this.element.click(function(event) {
                ...
                //self.show(self.element, 15, event.pageY - offset.top); //910 - offset.left   410
                self.show(self.element, 15, 17); //910 - offset.left   410

                //document.getElementById("colorPick").style.position = "absolute"
                //document.getElementById("colorPick").style.left = "10px";
                //document.getElementById("colorPick").style.top = "15px";
