    ...
    public class PriceCalculationServiceTests : ServiceTest
    {
        ...
        class TestProductService : ProductService
        {
            private TestProductService(CatalogSettings catalogSettings, CommonSettings commonSettings,
                ...
                LocalizationSettings localizationSettings, IHttpContextAccessor httpContextAccessor) : base(catalogSettings, commonSettings, aclService,
                ...
                storeMappingRepository,  tierPriceRepository, storeService, storeMappingService, workContext, localizationSettings, httpContextAccessor)
            {
            }
            ...
            public static TestProductService Init()
            {
                return new TestProductService(new CatalogSettings(), new CommonSettings(), null,
                    ...
                    null, null, null, null, null, null, new LocalizationSettings(), null);
            }
        }
    }
}